...
- **AI**: Anthropic Anthropic Sonnet 4.6 + Haiku 4.5 (prompt caching enabled)
...
See [`PROJECT.md`](./PROJECT.md) for full project memory, [`docs/judge-review-self-check.md`](./docs/judge-review-self-check.md) for our self-scoring against the four judging dimensions, and [`docs/d1-research.md`](./docs/d1-research.md) for the initial research notes.
